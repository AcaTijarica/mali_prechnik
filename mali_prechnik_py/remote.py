...
try:
    from .model import Entry, PROJECT_ROOT, clean_text, initial_letter, normalize_word, serbian_sort_key
except ImportError:
    from model import Entry, PROJECT_ROOT, clean_text, initial_letter, normalize_word, serbian_sort_key


GOOGLE_SERVICES_JSON = PROJECT_ROOT / "app" / "google-services.json"
